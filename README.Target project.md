...
The objective is to demonstrate **company-level analytical thinking**, strong **SQL querying skills**, and the ability to translate raw data into **actionable business insights** — aligned with expectations from **Big 4 / analytics interviews**.
...
2. **Business-Focused SQL**
   ...
   - Time-series and cohort-style analysis  
...
## 🧩 Sample Insights
- 📈 Revenue trend analysis highlights seasonality and growth patterns  
- 🔁 Repeat customer analysis indicates retention opportunities  
- 🚚 Late deliveries show lower average review scores  
- 🏆 A small set of sellers and categories drive most revenue  
- 🌍 Certain states dominate total sales  
...
- Big 4 interview case discussions  
- Input layer for Power BI / Tableau dashboards  
...
- Advanced KPI window functions  

---

## ✅ Key Takeaway
This project demonstrates not just SQL proficiency, but the ability to **think like a business analyst** — focusing on *why* a query matters and *how* it drives decisions.

> “Good SQL answers questions. Great SQL drives decisions.”
